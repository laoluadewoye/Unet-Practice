...
class ConvNd(nn.Module):
    ...
    def forward(self, nd_tensor):
        ...
        lower_dim_shape = [
            down_output_size(dim, self.kernel_size, stride=self.strides, padding=self.padding)
        ...
        high_dim_size = down_output_size(shape[2], self.kernel_size, stride=self.strides, padding=self.padding)
